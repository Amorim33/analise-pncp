...
4. `pncp-semantic-evaluator`: evaluate Q3 semantic quality, document/API alignment,
   and Codex subagent artifacts.
5. `pncp-report-writer`: generate or revise `analise-exploratoria.md`.
